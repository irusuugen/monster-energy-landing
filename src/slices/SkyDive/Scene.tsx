  ...
  return (
    <group ref={groupRef}>
        ...
        <Clouds ref={cloudsRef}>
            <Cloud ref={cloud1Ref} bounds={[10, 10, 2]} color="#eff1ed" opacity={0.2}/>
            <Cloud ref={cloud2Ref} bounds={[10, 10, 2]} color="#eff1ed" opacity={0.2}/>
        </Clouds>

        <group ref={wordsRef}>
            {sentence && <ThreeText sentence={sentence} color="#DAD7CD" />}
        </group>
